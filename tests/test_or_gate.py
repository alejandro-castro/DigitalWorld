from ..cktos.models.gates import OR


def test_or_default_1():
    gate = OR(2)  # default n_bits is 1
    outputs = []
...
def test_or_default_2():
    gate = OR(4)  # default n_bits is 1
    outputs = []
